...
type Screen = "branding" | "settings" | "seo" | "homepage" | "articles" | "surveys" | "resources" | "podcast" | "partners" | "social" | "analytics";
...
// ─── Sidebar ─────────────────────────────────────────────────────────────────
// Order matches editorial workflow: high-traffic editing first, config last.
const NAV_ITEMS: { key: Screen; label: string; icon: string }[] = [
  ...
  { key: "surveys", label: "Surveys", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
...
function ScreenRouter({ screen, supabase, admin, onEditArticle }: { screen: Screen; supabase: any; admin: AdminUser; onEditArticle: (a: any) => void }) {
  switch (screen) {
    ...
    case "surveys": return <SurveysScreen supabase={supabase} />;
    ...
    case "analytics": return <AnalyticsScreen supabase={supabase} />;
    default: return null;
  }
}
